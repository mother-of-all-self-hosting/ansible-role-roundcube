...
>[!NOTE]
> The role is configured to install nonroot container image, and therefore a couple of functions are not available without adding adjustments. Refer to [this section](https://github.com/roundcube/roundcubemail-docker/blob/master/README.md#nonroot-image) on the official documentation for details.
